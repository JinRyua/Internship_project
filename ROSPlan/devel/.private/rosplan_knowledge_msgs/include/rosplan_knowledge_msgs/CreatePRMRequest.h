...
bool operator==(const ::rosplan_knowledge_msgs::CreatePRMRequest_<ContainerAllocator1> & lhs, const ::rosplan_knowledge_msgs::CreatePRMRequest_<ContainerAllocator2> & rhs)
{

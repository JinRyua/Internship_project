...
namespace Custom
{
    ...
    private:
        ...
        std::vector<std::pair<custom_msgs::axis, int>> agents;   //agent들 좌표
        
        std::vector<std::vector<std::string>> map;   //map 
    ...
    public:
        ...
        void displayCallback(const board::display_info& msg);  //board가 보내는 display callback
